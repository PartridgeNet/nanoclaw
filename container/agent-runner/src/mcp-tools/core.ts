...
export const sendMessage: McpToolDefinition = {
      ...
      properties: {
        ...
        new_thread: {
          ...
          description:
            ...
            'Use this to start a fresh conversation in a channel rather than continue the existing thread.',
        },
      },
      required: ['to', 'text'],
    },
  ...
  async handler(args) {
    ...
    const seq = await writeMessageOut({
      id,
      // PartridgeNet: new_thread starts a fresh root message (drop reply + thread).
