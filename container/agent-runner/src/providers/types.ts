...
export type ProviderEvent =
  ...
  /**
   * A file generated by a provider-native tool that the model believes was
   * already delivered (for example Codex image generation). The poll-loop
   * copies it into the session outbox and delivers it to the current route.
   */
  | { type: 'file'; path: string; text?: string; filename?: string }
  /**
