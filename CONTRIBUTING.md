...
3. **Check for installation-specific files.** Before creating a PR, verify no installation-specific files (group files, `.claude/settings.json`, local configs) are in your diff.
